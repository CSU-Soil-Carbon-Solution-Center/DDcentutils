...
#' @param run character. Describes which DayCent block (equilibrium, baseline, or experimental scenario) to run based on the schedule file name. Accepted arguments are: "eq" for equilibrium, "base" for baseline, or a custom string for the experimental scenario (should match the schedule file name).
...
#' @param single_site_logic logical. Bypasses the spin up and directly runs the {site}.100 file. Default is FALSE.
#'
